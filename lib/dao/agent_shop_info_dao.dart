...
class AgentShopInfoDao {

  //商户入驻信息接口 - 基本信息接口
  static Future<Map<String, dynamic>?> doAgentShopInfoData(Map paramsMap) async {
    ...
    ValidateResult result =
        await HttpManager.instance.request(await Api.apiAgentShopInfoData(paramsMap));
