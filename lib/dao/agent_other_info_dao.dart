...
class AgentOtherInfoDao {

  //商户入驻信息接口 - 其他信息接口
  static Future<Map<String, dynamic>?> doAgentOtherInfoData(Map paramsMap) async {
    ...
    ValidateResult result =
        await HttpManager.instance.request(await Api.apiAgentOtherInfoData(paramsMap));
