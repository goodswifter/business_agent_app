...
class AgentLegalPersionInfoDao {

  //商户入驻信息接口 - 法人信息接口
  static Future<Map<String, dynamic>?> doAgentLegalPersionInfoData(Map paramsMap) async {
    ...
    ValidateResult result =
        await HttpManager.instance.request(await Api.apiAgentLegalPersionInfoData(paramsMap));
