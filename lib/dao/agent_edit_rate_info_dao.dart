...
class AgentEditRateInfoDao {

  //商户入驻信息接口 - 编辑费率信息接口
  static Future<Map<String, dynamic>?> doAgentEditRateInfoData(Map paramsMap) async {
    ...
    ValidateResult result =
        await HttpManager.instance.request(await Api.apiAgentEditRateInfoData(paramsMap));
