...
class AgentSubmitInfoDao {

  //商户入驻信息接口 - 新增提交信息
  static Future<Map<String, dynamic>?> doAgentSubmitInfoData(Map paramsMap) async {
    ...
    ValidateResult result =
        await HttpManager.instance.request(await Api.apiAgentSubmitInfoData(paramsMap));
